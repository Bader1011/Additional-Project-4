        ...
        return (
            <div>
                <form onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <input type="text" name="email" onChange={this.handleChange.bind(this)} placeholder={this.props.user.email} /><hr />
                    <input type="number" name="phone" onChange={this.handleChange.bind(this)} placeholder={this.props.user.phone} />
